<script>
    ...
    const navigation = [
        ...
        { name: 'Órdenes OC',  href: '/purchase-orders', icon: 'order' },
        { name: 'Reportes',    href: '/reports',          icon: 'chart' },
    ];
        ...
        <header class="flex-shrink-0 flex items-center justify-between h-14 px-6 border-b border-slate-800 bg-slate-900/40">
            ...
            <div class="flex items-center gap-2">
                ...
                <button
                    ...
                    class="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-sm text-slate-400 hover:text-slate-200 transition-colors"
                >
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0"/>
                    </svg>
                    <span class="text-xs">Buscar</span>
                    <kbd class="ml-1 inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-xs font-mono text-slate-500 border border-slate-700 bg-slate-900">Ctrl K</kbd>
                </button>
