...
<svelte:head><title>Nuevo producto</title></svelte:head>
...
<AppLayout>
    <div class="flex-1 overflow-y-auto">
        ...
        <div class="border-b border-slate-800 px-8 py-5 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl font-semibold text-white">Nuevo producto</h1>
                <p class="text-sm text-slate-400 mt-0.5">Completa los datos para registrar el producto</p>
            </div>
        </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-5">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="sku" class="block text-sm font-medium text-slate-300 mb-1.5">
                                        SKU <span class="text-slate-500">(auto si vacío)</span>
                                    </label>
                                    <input
                                        id="sku"
                                        type="text"
                                ...
                                <div>
                                    <label for="barcode" class="block text-sm font-medium text-slate-300 mb-1.5">
                                        Código de barras
                                    </label>
                                    <input
                                        id="barcode"
                            ...
                            <div>
                                <label for="short_description" class="block text-sm font-medium text-slate-300 mb-1.5">
                                    Descripción corta
                                </label>
                                <input
                        ...
                        <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-5">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="compare_price" class="block text-sm font-medium text-slate-300 mb-1.5">
                                        Precio comparativo <span class="text-slate-500">(tachado)</span>
                                    </label>
                                    <div class="relative">
                                        <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-500 text-sm">$</span>
                                        <input
                        ...
                        <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-5">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label for="max_stock" class="block text-sm font-medium text-slate-300 mb-1.5">
                                        Stock máximo <span class="text-slate-500">(opcional)</span>
                                    </label>
                                    <input
                                        id="max_stock"
                                        type="number"
                            ...
                            <div class="flex gap-6">
                                ...
                                <label class="flex items-center gap-2.5 cursor-pointer">
                                    <input
                                        type="checkbox"
                                        bind:checked={$form.allow_backorder}
                                        class="w-4 h-4 rounded border-slate-600 bg-slate-800 text-indigo-500 focus:ring-indigo-500 focus:ring-offset-slate-900"
                                    />
                        ...
                        <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    <input
                                        type="number"
                                        bind:value={$form.dimensions_length}
                                        min="0"
                                        step="0.01"
                                        placeholder="Largo"
                                        class="w-full px-3.5 py-2.5 bg-slate-800 border border-slate-700 focus:border-indigo-500 rounded-lg text-sm text-white placeholder-slate-500 outline-none transition-colors"
                                    ...
                                    <input
                                        type="number"
                                        bind:value={$form.dimensions_width}
                                        min="0"
                                        step="0.01"
                                        placeholder="Ancho"
                                        class="w-full px-3.5 py-2.5 bg-slate-800 border border-slate-700 focus:border-indigo-500 rounded-lg text-sm text-white placeholder-slate-500 outline-none transition-colors"
                                    ...
                                    <input
                                        type="number"
                                        bind:value={$form.dimensions_height}
                                        min="0"
                                        step="0.01"
                                        placeholder="Alto"
                                        class="w-full px-3.5 py-2.5 bg-slate-800 border border-slate-700 focus:border-indigo-500 rounded-lg text-sm text-white placeholder-slate-500 outline-none transition-colors"
