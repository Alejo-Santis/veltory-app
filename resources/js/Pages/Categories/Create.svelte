...
<svelte:head><title>Nueva categoría</title></svelte:head>
...
<AppLayout>
    <div class="flex-1 overflow-y-auto">
        <div class="border-b border-slate-800 px-8 py-5 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl font-semibold text-white">Nueva categoría</h1>
                <p class="text-sm text-slate-400 mt-0.5">Completa los datos para crear la categoría</p>
            </div>
        </div>

        <div class="p-8 max-w-2xl">
            <div class="mb-6">
                <Breadcrumb items={[{ label: 'Categorías', href: '/categories' }, { label: 'Nueva categoría' }]} />
            </div>
